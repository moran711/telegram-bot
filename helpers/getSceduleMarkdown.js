...
const getSceduleMarkdown = (scedule, day, subgroup) => {
  ...
  const sceduleForSubgroup = [...allSceduleForDay.general, ...allSceduleForDay[subgroups[subgroup]]].sort((a, b) => a.couple - b.couple)
  return sceduleForSubgroup.length ? `<b>Ваш розклад:</b>\n\n${sceduleForSubgroup
